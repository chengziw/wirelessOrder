/*
SQLyog v10.2 
MySQL - 5.5.20 : Database - wireless
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`wireless` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
insert  into `usertbl`(`id`,`username`,`password`,`name`,`gender`,`permission`,`remark`) values (1,'admin','admin','shun22','男22',1,'大帅哥');

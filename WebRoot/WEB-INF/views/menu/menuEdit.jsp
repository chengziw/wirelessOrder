...
<div class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="/WirelessOrder/menu.do?flag=updMenu" method="post" class="form-horizontal"  enctype="multipart/form-data" >    
            <div class="row-fluid">
               <div class="span7">  	
               <input name="id"  id="name" type="hidden" value="${menu.id}">
					<div class="control-group">
							<label class="control-label" for="names">菜 名</label>
							<div class="controls">
							<input name="name" class="input-xlarge focused" id="names" type="text" value="${menu.name}">
							</div>
					</div>
					<div class="control-group">
							<label class="control-label" for="price">价 格</label>
							<div class="controls">
							<input name="price" class="input-xlarge focused" id="price" type="text" value="${menu.price}">
							</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
							...
							<div class="controls">
							<textarea rows="4" cols="20" name="remark" id="remark">${menu.remark}</textarea>
							</div>
					</div>
				...
				<div class="span5">
					<div class="fileupload fileupload-new" data-provides="fileupload">
					  <div class="fileupload-new thumbnail" style="width: 220px; height: 170px;"><img src="/WirelessOrder/images/${menu.pic}" /></div>
					  ...
					  <input type="file" name="photo" value="/WirelessOrder/images/${menu.pic}" />
					  </span>
